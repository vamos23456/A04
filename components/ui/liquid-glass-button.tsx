...
interface MetalButtonProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "variant"> {
...
const MetalButton = React.forwardRef<HTMLButtonElement, MetalButtonProps>(
  ({ children, className, variant = "default", ...props }, ref) => {
    ...
    const variants = metalButtonVariants(resolvedVariant, isPressed, isHovered, isTouchDevice)
